...
// and turns them into clean JSON responses instead of ugly stack traces
...
public class GlobalExceptionHandler {
    ...
    // Handles 400 - validation failures (@NotBlank, @NotNull, etc.)
    ...
    // Handles 409 - unique constraint violations (e.g. duplicate slug)
